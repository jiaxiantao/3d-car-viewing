...
- Read [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) and [docs/market-glb-rig.md](docs/market-glb-rig.md) when touching GLB or rig code.
...
4. **3D assets:** if you add/replace GLBs, update [docs/ATTRIBUTION.md](docs/ATTRIBUTION.md) and `public/models/market/README.md` with license and author.
